...
describe('<Input />', () => {
  ...
  beforeEach(() => {
    change = ''
    inputComponent = mount(<Input input={{ value: '123', name: 'test', onChange: (e) => change = e.target.value }} />).find('input')
  })
  ...
  it('can have custom props', () => {
    const customComponent = mount(<Input input={{}} placeholder='123' />).find('input')
